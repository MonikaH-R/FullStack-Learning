...
function App() {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      const chatHistory = [{ role: "user", parts: [{ text: userMessageText }] }];
      const payload = { contents: chatHistory };

      const apiKey = "AIzaSyAbzgYFvuhfJXK58zAZQuek0mbdpwBzyu8";
  ...
  return (
    <div className="d-flex justify-content-center align-items-center min-vh-100 bg-light p-3">
      ...
      >
        <div className="card-header text-center text-white py-3" style={{ background: 'linear-gradient(to right, #ff69b4, #87cefa)' }}>
          <h1 className="h5 mb-0">My AI Chatbot</h1>
        </div>
